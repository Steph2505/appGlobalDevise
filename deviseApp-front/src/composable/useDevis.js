...
export function useDevis() {
  ...
  async function fetchAll() {
    try { 
      ...
      console.log('Erreur chargement devis :', e) 
    }
  }
  ...
  async function create(data) {
    try { 
      ...
      console.log('Erreur création devis :', e); return false
    }
  }
  ...
  async function update(id, data) {
    try { 
      ...
      console.log('Erreur modification devis :', e); return false 
    }
  }
  ...
  async function remove(id) {
    ...
    try { 
      await store.remove(id); return true 
    }
    catch (e) { 
      console.log('Erreur suppression devis :', e);
      return false 
    }
  }
